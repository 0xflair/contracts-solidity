...
export interface IERC1155MetadataExtraInterface extends ethers.utils.Interface {
  functions: {
...
export class IERC1155MetadataExtra extends BaseContract {
  ...
  interface: IERC1155MetadataExtraInterface;
