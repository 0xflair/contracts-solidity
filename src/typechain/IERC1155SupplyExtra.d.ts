...
export interface IERC1155SupplyExtraInterface extends ethers.utils.Interface {
  functions: {
...
export class IERC1155SupplyExtra extends BaseContract {
  ...
  interface: IERC1155SupplyExtraInterface;
