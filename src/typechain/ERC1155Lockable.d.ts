...
export interface ERC1155LockableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155Lockable extends BaseContract {
  ...
  interface: ERC1155LockableInterface;
