...
export interface TieredSalesERC2771Interface extends ethers.utils.Interface {
  functions: {
...
export class TieredSalesERC2771 extends BaseContract {
  ...
  interface: TieredSalesERC2771Interface;
