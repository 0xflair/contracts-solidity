...
export interface ERC1155MetadataOwnableInterface extends ethers.utils.Interface {
  functions: {
...
export class ERC1155MetadataOwnable extends BaseContract {
  ...
  interface: ERC1155MetadataOwnableInterface;
