 ...
 * @custom:provides-interfaces IERC721 IERC721ABase IERC721Mintable IERC721Lockable IERC721Burnable
 */
contract ERC721A is ERC721ABase, ERC721AMintable, ERC721ALockable, ERC721ABurnable {
    /**
    ...
    function _beforeTokenTransfers(
        ...
        uint256 quantity
    ) internal virtual override(ERC721ABaseInternal, ERC721ALockableInternal) {
        ERC721ALockableInternal._beforeTokenTransfers(from, to, startTokenId, quantity);
    }
}
